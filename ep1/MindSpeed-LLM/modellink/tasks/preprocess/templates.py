...
_register_template(
    name="zen",
    format_user=StringFormatter(slots=["<|user_start|>{{content}}<|user_end|>"] ),
    format_assistant=StringFormatter(slots=["<|assistant_start|>{{content}}<|assistant_end|>", {"eos_token"}]),
    format_system=StringFormatter(slots=["<|user_start|>{{content}}<|user_end|>"] ),
    format_observation=StringFormatter(slots=["<|assistant_start|>{{content}}<|assistant_end|>"] ),
    format_prefix=EmptyFormatter(slots=["<|bos|>"] ),
    stop_words=["<|assistant_end|>"],
    replace_eos=True,
)
