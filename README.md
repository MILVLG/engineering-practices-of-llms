...
- `ep3/`：第3次实践课代码，目标为掌握LLM后训练中基于GRPO强化学习的基本技术和流程，实现一个小型LLM的后训练和评估，对微调方法和参数等进行实验分析。
- `ep4/`：第4次实践课代码，目标为掌握利用 LangChain 实现针对特定报告的问答。
- `ep5/`：第5次实践课代码，目标为掌握利用 LangGraph 构建全自动笔记 Agent。
